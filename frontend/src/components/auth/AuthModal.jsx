  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/unauthorized-domain') {
        setError("Domain not authorized in Firebase. Please add 'localhost' to Authorized Domains in Firebase Console (Authentication > Settings > Authorized domains) with support email prafulsonwane58@gmail.com, or log in with Email & Password below.");
      } else {
